                        ...
                        <div class="panel-body panelMensajes">
                            <table id="tab_ordena" class="tabla table tablaMen">
                                ...
                                <tr>
                                    ...
                                    <th class="col-md-3">Destinatario</th>
                                ...
                                <?php foreach ($mensajes as $mensaje): ?>
                                    <tr>
                                        <td class="menMensaje primEl col-md-4">
                                            <a href="mensaje/enviado?id=<?php echo $mensaje["id_mensaje_env"]; ?>">
                                        ...
                                        <td class="col-md-2">
                                            <form id="borrarMen" method="post" action="mensaje/eliminarEnv">
                                                ...
                                                <input type="hidden" name="id_mensaje"
                                                       value="<?php echo $mensaje["id_mensaje_env"]; ?>">
                                                <input type="hidden" name="id_emisor"
                                                       value="<?php echo $mensaje["emisor"]; ?>">
                                            </form>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                ...
                                <ul class="pagination">
                                    <li>
                                        <?php if (isset($pag) && $pag > 1) {
                                            echo '<a href = "mensaje/enviados?pag=' . ($pag - 1) . '" aria-label = "Anterior" >
                                    ...
                                    if (!isset($pag) || $pag == 1) {
                                        for ($i = 1; $i <= $num_pag && $i <= 5; $i++) {
                                            if ($i == 1) {
                                                echo '<li class="active"><a href="mensaje/enviados?pag=' . $i . '">' . $i . '</a></li>';
                                            } else {
                                                echo '<li><a href="mensaje/enviados?pag=' . $i . '">' . $i . '</a></li>';
                                            }
                                        }
                                    ...
                                    <li>
                                        <?php if (isset($pag) && $pag < $num_pag) {
                                            echo '<a href="mensaje/enviados?pag=' . ($pag + 1) . '" aria-label="Siguiente">
                                                <span aria-hidden="true">&raquo;</span>
                                            </a>';
                                        } elseif (!isset($pag) && $num_pag > 1) {
                                            echo '<a href="mensaje/enviados?pag=' . 2 . '" aria-label="Siguiente">
                                                <span aria-hidden="true">&raquo;</span>
                                            </a>';
                                        } else {
